        ...
        attach: function (context, settings) {
            $("#application-button").on("click", function(e) {
                ...
                if (now > start && now < end) {
                    ...
                    location.assign("https://ucl-rm-cubase.powerappsportals.com/selection_summary/?route_code=" + route_code + "&marketed_course_code=" + $("input[name=marketed_course_code]").val() + "&academic_year=" + academic_year + "&mode_of_attendance=" + mode_of_attendance);
                } else {

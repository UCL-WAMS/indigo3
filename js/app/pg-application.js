        ...
        attach: function (context, settings) {
            $("#application-button").on("click", function(e) {
                ...
                if (now > start && now < end) {
                    ...
                    var visa_required = $("input[name=DeclaredVisaRequired]:checked", "#application-form").val()
                    alert("https://ucl-rm-cubase.powerappsportals.com/selection_summary/?route_code=" + route_code + "&marketed_course_code=" + marketed_course_code + "&academic_year=" + academic_year + "&mode_of_attendance=" + mode_of_attendance + "&DeclaredVisaRequired=" + visa_required);
                    location.assign("https://ucl-rm-cubase.powerappsportals.com/selection_summary/?route_code=" + route_code + "&marketed_course_code=" + marketed_course_code + "&academic_year=" + academic_year + "&mode_of_attendance=" + mode_of_attendance + "&DeclaredVisaRequired=" + visa_required);
                } else {
